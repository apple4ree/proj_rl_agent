...
if TYPE_CHECKING:
    from layer2_position import RiskCaps, TargetBuilder
    from layer4_execution import SlicingPolicy, PlacementPolicy
    from layer5_simulator import FeeModel, ImpactModel, LatencyModel, MatchingEngine
...
class ComponentFactory:
    ...
    def build_latency_model(cfg: "LatencyConfig", seed: int | None = None) -> "LatencyModel":
        ...
        """
        from layer5_simulator.latency_model import LatencyModel, LatencyProfile
    ...
    def build_matching_engine(cfg: "ExchangeConfig", seed: int | None = None) -> "MatchingEngine":
        ...
        """
        from layer5_simulator.matching_engine import MatchingEngine, ExchangeModel, QueueModel
    ...
    def build_placement_policy(cfg: "PlacementConfig") -> "PlacementPolicy":
        ...
        """
        from layer4_execution.placement_policy import (
    ...
    def build_risk_caps(cfg: "RiskConfig", initial_cash: float) -> "RiskCaps":
        ...
        """
        from layer2_position.risk_caps import RiskCaps
    ...
    def build_target_builder(cfg: "RiskConfig") -> "TargetBuilder":
        ...
        """
        from layer2_position.target_builder import TargetBuilder
