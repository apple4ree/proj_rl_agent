...
사용법:
    ...
    PYTHONPATH=. python scripts/collect_data.py 005930 000660
    PYTHONPATH=. python scripts/collect_data.py --symbols 005930 000660 138080 --out-dir data/raw
"""
...
def main() -> None:
    ...
    if not args.symbols:
        ...
        print("예시: python scripts/collect_data.py 005930 000660")
        sys.exit(1)
